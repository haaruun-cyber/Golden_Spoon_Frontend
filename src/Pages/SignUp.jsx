          ...
          <div className="lg:w-1/2 bg-linear-to-br from-gold-500 to-gold-700 p-8 lg:p-12 flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-5xl font-bold text-white mb-6 leading-tight">
                Welcome<br />to<br />Fine Dining Experience!
              </h2>

              <p className="text-white/90 text-lg mb-12">
                 sigup to continue your culinary journey with us. We've missed you!
              </p>
          ...
          <div className="lg:w-1/2 p-8 lg:p-12 bg-white">
            <div className="max-w-md mx-auto">
              ...
              <div className="text-center mb-8">
                <h3 className="text-3xl font-bold text-gray-800 mb-2">Create Acount</h3>
              ...
              <div className="mt-8 space-y-4">
                <p className="text-center text-gray-600">
                  ...
                  <Link to="/login" className="text-gold-600 hover:text-gold-700 font-semibold hover:underline">
                    Login
                  </Link>
                </p>
